...
# Filename : class_naming_machine.py
# author by : （学员ID)
...
class NamingMachine:
    ...
    # 产生一个中国人的全名
    def pick_full_name(self):

        # 随机挑选姓氏
        family_name = self._pick_family_name()
        # 士兵都是男的
        sex = random.randint(1, 2)
        # sex = 1

        # 随机挑选名
        given_name = self._pick_given_name(sex)
    ...
    def _pick_family_name(self):
        ...
        picked_name = random.choice(family_names)
        return picked_name

    # 建立一个函数，可以随机产生一个中国人的名称
    def _pick_given_name(self, is_boy):
        # 男孩们的单字名
        boys_given_words1 = ( \
